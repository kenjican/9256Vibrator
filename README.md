...
(17): still have to get running status of U8256,for example: 终了 steps value still the last step value, not null nor zero...if the vibrator running on last step,,it would keep vibrating.
